...
export default function OpenAI() {
    ...
    return (
        ...
        <div style={{ marginTop: '9rem' }}>
          ...
          <button className="pinterest-btn" onClick={() => setSelectedService("tra")}>{t("comic name translator")}</button>
          <button className="pinterest-btn" onClick={() => setSelectedService("list")}>{t("list of comic")}</button>
          <button className="pinterest-btn" onClick={() => setSelectedService("clas")}>{t("list of comic genres")}</button>
          ...
          {selectedService === "list" && (
            <div>
              <main>
                <h3 className="text-center fly">{t("comic of the genre")}</h3>
                <form onSubmit={onSubmitlist}>
                  <div className="cont-center">
                    <input
                      type="text"
                      name="animal"
                      placeholder={t("genre of comic")}
                  ...
                  <br />
                  <div className="cont-center">
                    <input type="submit" className="pinterest-btn pinterest-btn--black" value={t("generate comic")} />
                  </div>
                </form>
                <br />
          ...
          {selectedService === "clas" && (
            <div>
              <main>
                <h3 className="text-center fly">{t("genre of comic")}</h3>
